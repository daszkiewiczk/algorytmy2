# Test wydajności dla 10 plików z danymi
import numpy as np
...
if __name__ == '__main__':
    for k in range(10):
        ...
        plik = open("DaneTestowe/dane_5.txt", "r")
        ...
        print("potrzebny czas przy " + str(k) + " przejsciu: " + str(end_time - start_time) + "\n\n")